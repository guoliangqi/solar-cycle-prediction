# -*- coding: utf-8 -*-
"""
Created on Tue Dec 25 21:50:25 2018
...
HIDDEN_SIZE = 35                            # LSTM中隐藏节点的个数。
NUM_LAYERS = 2                              # LSTM的层数。
TIMESTEPS = 10                              # 循环神经网络的训练序列长度。
TRAINING_STEPS = 10000                      # 训练轮数。
BATCH_SIZE = 32                             # batch大小。
TRAINING_EXAMPLES = 2839                    # 训练数据个数。
TESTING_EXAMPLES = 130                      # 测试数据个数。
SAMPLE_GAP = 0.01
...
group_labels = ['1986','', '1988','','1990','','1992','','1994','']
...
for i in range(130):
    X2.append(b[0][2828+i: i + 2838])
    y2.append(b[0][i + 2838])
