# -*- coding: utf-8 -*-
"""
Created on Thu Dec 27 11:02:31 2018
...
HIDDEN_SIZE = 28                            # LSTM中隐藏节点的个数。
NUM_LAYERS = 2                              # LSTM的层数。
TIMESTEPS = 10                              # 循环神经网络的训练序列长度。
TRAINING_STEPS = 10000                      # 训练轮数。
BATCH_SIZE = 25                            # batch大小。
TRAINING_EXAMPLES = 2395                    # 训练数据个数。
TESTING_EXAMPLES = 111                      # 测试数据个数。
SAMPLE_GAP = 0.01
...
X2 = []
y2 = []
xx = [0,12,24,36,48,60,72,84,96,108]
group_labels = ['2009','', '2011','','2013','','2015','','2017','']
...
for i in range(111):
    X2.append(b[0][2384+i: i + 2394])
    y2.append(b[0][i + 2394])
