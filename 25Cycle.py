# -*- coding: utf-8 -*-
"""
Created on Tue Dec 25 17:02:45 2018
...
HIDDEN_SIZE = 25                            # LSTM中隐藏节点的个数。
NUM_LAYERS = 2                              # LSTM的层数。
TIMESTEPS = 10                              # 循环神经网络的训练序列长度。
TRAINING_STEPS = 10000                      # 训练轮数。
BATCH_SIZE = 28                             # batch大小。
TRAINING_EXAMPLES = 3227                    # 训练数据个数。
TESTING_EXAMPLES = 154                      # 测试数据个数。
SAMPLE_GAP = 0.01
...
X2 = []
y2 = []
xx = [8,20,32,44,56,68,80,92,104,116,128]
group_labels = ['2019','', '2021','','2023','','2025','','2027','','2029']
...
for i in range(154):
    X2.append(b[0][3216+i: i + 3226])
    y2.append(b[0][i + 3226])
